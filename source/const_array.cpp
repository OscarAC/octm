...
export module octm:const_array;
import :idioms;
...
struct const_array final : with_const_size<N> {
  ...
  constexpr const T &operator[](const size_t I) const noexcept { return mem_[I]; }

  constexpr operator const T &() const noexcept { return mem_; }
...
template <class... T>
const_array(T... type) -> const_array<variadic_reduce_t<T...>, sizeof...(T)>;
